...
class VOCDataset(Dataset):
    ...
    def __init__(self, is_train, input_dir, target_dir, image_dir, label_txt, image_size=512, grid_size=8, num_bboxes=2, num_classes=2):
    ...
    def __getitem__(self, idx):
        ...
        if idx >= len(self.target_names):
            raise IndexError(f"Index {idx} out of range for target_names (size: {len(self.target_names)})")
        ...
        input_image = transforms.Resize((512, 512))(input_image)
        target_image = transforms.Resize((512, 512))(target_image)
